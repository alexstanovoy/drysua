...
pub const PPO_SCHEMA_VERSION: u32 = 32;
/// Audited simulator and learner rules required by stage-nine rollouts.
pub const PPO_RULES_AUDIT_VERSION: u32 = 27;
/// Canonical stage-nine learner contract covered by [`PPO_SCHEMA_HASH`].
pub const PPO_SCHEMA_DESCRIPTOR: &str = concat!(
    "bota-drysua-ppo/v32;",
    "linked_schemas=action,feature,model,map2_reward;linked_hash=fnv1a_descriptor_then_ordered_version_le32_hash_le64_then_map2_reward_descriptor_utf8;rules_audit=27;",
    ...
    "reward=linked_map2_reward3_schema_version_hash_and_full_descriptor,seat_only_full_contiguous_snapshot_events_before_retention_or_tracker_journal,full_v2_components_plus_stagnation_base_stagnation_ticks_cost,baseline_free_debt0_inactive_add1_including_death_cap2700_activity_refresh30_current_consumed_active_repay3_base.02_once_then_inactive_cap.000002_rearm_only_zero_no_stagnation_refund,no_clipping;activity=counter_deltas_and_original_events_direct_own_effect3_positive_ticks_even_full_or_lingering_purchase_partial_lease_only;accounting_state=feature17_existing_wait_and_budget_facts_plus_debt_lease_latch,progress_reason_u16_OR_merge;dominance=negative_absolute_bound.7138_plus_full_positive_bound.255_equals.9688_lt1_not_symmetric_twice_dense;simple_wait=unchanged_v2_any_movement_or_resource_break_resets_any_own_purchase_full_open_period_refund_no_price_intent_antiabuse_conditions;no_action_or_Teacher_override;",
    ...
    "deployment=raw_map2_mid_neural_policy_no_teacher_override_or_strategic_masks,action5_mango_public_readiness_unchanged,feature17_anonymous_raze_effect15_guarded13_inspired14_manual_hp_mana_reports_wait_and_progress_accounting,raw_ppo_sampling_remains_on_policy;",
...
const _: () = assert!(MODEL_SCHEMA_VERSION == 19);
const _: () = assert!(PPO_RULES_AUDIT_VERSION == 27);
