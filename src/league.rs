...
pub const LEAGUE_SCHEMA_VERSION: u32 = 10;
/// Audited simulator rules required by stage-ten league artifacts.
pub const LEAGUE_RULES_AUDIT_VERSION: u32 = 9;
...
pub const LEAGUE_SCHEMA_DESCRIPTOR: &str = concat!(
    ...
    "ppo_schema_version=9;ppo_schema_hash=3472679473598337579;rules_audit=9;",
...
const _: () = assert!(PPO_SCHEMA_VERSION == 9);
const _: () = assert!(PPO_SCHEMA_HASH == 3_472_679_473_598_337_579);
