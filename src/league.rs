...
pub const LEAGUE_SCHEMA_VERSION: u32 = 35;
/// Audited simulator and learner rules required by stage-ten league artifacts.
pub const LEAGUE_RULES_AUDIT_VERSION: u32 = 30;
...
pub const LEAGUE_SCHEMA_DESCRIPTOR: &str = concat!(
    "bota-drysua-league/v35;",
    "linked_schemas=action,feature,model,ppo,map2_reward;linked_hash=fnv1a_descriptor_then_ordered_version_le32_hash_le64_then_map2_reward_descriptor_utf8;rules_audit=29;",
    ...
    "current_contract=feature20_model22_ppo35_reward6_win.2_loss_neg.2_draw0_completed_taskcap_neg.2;mastery_training_gate_is_not_league_qualification;explicit_pinned_parameter_initialization_fresh_mastery_progress_no_equivalence;"
);
...
const _: () = assert!(PPO_SCHEMA_VERSION == 35);
